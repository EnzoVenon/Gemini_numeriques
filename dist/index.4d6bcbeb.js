...
var _connectDataToBuidlings = require("./models/connectDataToBuidlings");
var _ortho = require("./models/ortho");
var _elevation = require("./models/elevation");
var _streamSurfaceFeature = require("./models/streamSurfaceFeature");
var _baseMenu = require("./GUI/BaseMenu");
(0, _baseMenu.setUpMenu)();
// ----------------- View Setup ----------------- //
...
let iris_layer = (0, _streamSurfaceFeature.addStreamSurfaceFeature)("https://wxs.ign.fr/cartovecto/geoportail/wfs?", "2.0.0", "STATISTICALUNITS.IRIS:contours_iris", "EPSG:4326", 10, "iris", {
    west: 0.67289,
    east: 0.74665,
    south: 45.17272,
    north: 45.2135
...
for (const layer of view.getLayers())if (layer.id === "WFS Building") layer.whenReady.then(function _(layer) {
    ...
    window.addEventListener("click", (event)=>{
        (0, _connectDataToBuidlings.picking)(event, view);
    }, false);
});

},{"./models/elevation":"2x72h","./models/building":"8WZDc","./models/connectDataToBuidlings":"jVSQ3","./models/ortho":"3i7rY","./models/streamSurfaceFeature":"8AvfE","./GUI/BaseMenu":"lD58a"}],"2x72h":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jVSQ3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "picking", ()=>picking);
var _showChart = require("./insee/showChart");
async function picking(event, view) {
    if (view.controls.isPaused) {
        ...
        if (intersects.length) {
            ...
            htmlInfo.innerHTML += "<li>population par groupe pat\xe9 de maison</li>";
            htmlInfo.innerHTML += '<div style="width:100%;"><canvas id="pop"></canvas></div>';
            htmlInfo.innerHTML += "<li>population par age par groupe pat\xe9 de maison</li>";
            htmlInfo.innerHTML += '<div style="width:100%;"><canvas id="pop2"></canvas></div>';
            const data = [
                {
                    pop: "total",
                    count: dataJson.population
                },
                {
                    pop: "homme",
                    count: dataJson.population_male
                },
                {
                    pop: "femme",
                    count: dataJson.population_female
                }
            ];
            let dataAge = [];
            ...
            (0, _showChart.addChart)("pop", data, "pop", "count", "population");
            (0, _showChart.addChart)("pop2", dataAge, "age", "count", "population par age");
        }
    }
}

},{"./insee/showChart":"aANyJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aANyJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addChart", ()=>addChart);
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
function addChart(divId, data, xdata, ydata, label) {
    return new (0, _autoDefault.default)(document.getElementById(divId), {
        type: "bar",
        data: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8AvfE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addStreamSurfaceFeature", ()=>addStreamSurfaceFeature);
function addStreamSurfaceFeature(url, version, typeName, crs, zoomMin, layerName, extent) {
    ...
    return {
        surface_layer: wfsCartoLayer,
        label_layer: wfsCartoLabelLayer,
        geom: geomLayer
    };
}
function setColor() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lD58a":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setUpMenu", ()=>setUpMenu);
function setUpMenu() {
