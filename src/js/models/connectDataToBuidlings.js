...
const attribut2UserName = {
  ...
  dpe_conso_ener_std: "Dispersion des valeurs de consommation énergétique du bâtiment",
  ...
  dpe_estim_ges_std: "Dispersion des valeurs d'émission de Gaz à effet de serre du bâtiment. ",
